...
| Element                      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `address`                    | IP Address used by cluster components to talk to the API server. Also serves as one of the addresses pushed on the k0s create service certificate on the API. Defaults to the first global unicast address found on the node. The loopback interface, interfaces that are down and known CNI interfaces are skipped, as are addresses that are not global unicast, such as the link-local addresses used by management NICs. A virtual IP is therefore not picked up while it lives on loopback or on `dummyvip0`, but set this option explicitly if a VIP can appear on a regular interface. |
| `onlyBindToAddress`          | The API server binds to all interfaces by default. With this option set to `true`, the API server will only listen on the IP address configured by the `address` option (auto-detected by default, see `address`). This can be necessary with multi-homed control plane nodes.                                                                                                                                                                                                                                                                                                                |
...
| `etcd.peerAddress`                | Node address used for etcd cluster peering. Defaults to the same auto-detected address as `spec.api.address`.                                                                                                                                      |
